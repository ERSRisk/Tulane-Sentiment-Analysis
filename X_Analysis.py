...
# Set up page config
st.set_page_config(page_title="Tulane Sentiment Dashboard", layout="wide")

# Sidebar navigation
st.sidebar.title("Navigation")
page = st.sidebar.radio("Go to", ["Homepage", "News Analysis", "X Analysis"])
...
if page == "Homepage":
    ...
    st.write("Use the sidebar to explore sentiment tools:")
    st.markdown("""
    - **News Analysis**
    - **X Analysis**
    """)
elif page == "News Analysis":
    run_news_analysis()  # You must define this function below
elif page == "X Analysis":
    run_x_analysis()  # You must define this function below
...
| pipeline/resources/risks.json                           | Review and relocate                          | Risk taxonomy/configuration file; business logic should be stored separately from generated artifacts | Controlled Config Storage         |
